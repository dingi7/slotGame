...
const assets = [
  { image: "https://png.pngtree.com/png-clipart/20210123/ourmid/pngtree-black-colorful-number-1-png-image_2786493.jpg", value: 1 },
  { image: "https://png.pngtree.com/png-clipart/20210123/ourmid/pngtree-black-colorful-number-1-png-image_2786493.jpg", value: 2 },
  { image: "https://png.pngtree.com/png-clipart/20210123/ourmid/pngtree-black-colorful-number-1-png-image_2786493.jpg", value: 3 },
  { image: "https://png.pngtree.com/png-clipart/20210123/ourmid/pngtree-black-colorful-number-1-png-image_2786493.jpg", value: 4 },
  { image: "https://png.pngtree.com/png-clipart/20210123/ourmid/pngtree-black-colorful-number-1-png-image_2786493.jpg", value: 5 },
  { image: "https://png.pngtree.com/png-clipart/20210123/ourmid/pngtree-black-colorful-number-1-png-image_2786493.jpg", value: 6 },
  { image: "https://png.pngtree.com/png-clipart/20210123/ourmid/pngtree-black-colorful-number-1-png-image_2786493.jpg", value: 7 },
  { image: "https://png.pngtree.com/png-clipart/20210123/ourmid/pngtree-black-colorful-number-1-png-image_2786493.jpg", value: 8 },
  { image: "https://png.pngtree.com/png-clipart/20210123/ourmid/pngtree-black-colorful-number-1-png-image_2786493.jpg", value: 9 },
];
const columns = 3;
const rows = 3;
...
export const SlotMachine: React.FC = () => {
  ...
  const drawRect = (graphics: PIXI.Graphics) => {
    ...
    graphics.drawRoundedRect(
      ...
      slotHeight * rows * (windowWidth <= 768 ? 2 : 1),
      5
    );
    graphics.endFill();
  };
  ...
  const drawLine = (graphics: PIXI.Graphics) => {
    ...
    graphics.lineTo(windowWidth * 0.391 * (windowWidth <= 768 ? 2 : 1), slotHeight * 1.5);
    graphics.endFill();
  };
