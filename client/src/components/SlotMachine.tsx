    ...
    setAssetsMatrix((prevMatrix) => {
      const newMatrix = prevMatrix.map((column) => {
        ...
        for (let i = shuffledColumn.length - 1; i > 0; i--) {
          ...
          [shuffledColumn[i], shuffledColumn[j]] = [
            shuffledColumn[j],
            shuffledColumn[i],
          ];
        }
    ...
    <div className="w-full h-full flex flex-col justify-center items-center gap-5">
      ...
      <div className="w-full flex gap-[10%] justify-center items-center">
        <div className="flex gap-4 text-2xl border-2 rounded-lg p-[0.2%]">
          <button className="border-slate-200 border-2 py-[8%] px-4 rounded-tl-lg rounded-bl-lg shadow">
            -
          </button>
          ...
          <button className="border-slate-200 border-2 py-[8%] px-4 rounded-tr-lg rounded-br-lg shadow">
            +
          </button>
        </div>
